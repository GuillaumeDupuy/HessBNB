        ...
        <div class="row footer-grids">
            ...
            <div class="col-lg-2 col-6 footer-grid footer-contact mt-lg-0 mt-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="mailto:onsefoutdevotre@gueule.com">onsefoutdevotre@gueule.com</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <p class="col-lg-8 copy-right-grids text-wh text-lg-left text-center mt-lg-2">
                © 2019 AirHess. All Rights Reserved | Design by
                <a href="https://www.ynov-paris.com/?gclid=Cj0KCQjww_f2BRC-ARIsAP3zarHt1YCO6lzFJw5goGy1ei7Kc0I62hrCYlcCnPFHnjjUgGP2XmTKEb4aAmzbEALw_wcB" target="_blank">Ynov Paris Campus</a>
            </p>
            <!-- //copyright -->
            <!-- social icons -->
